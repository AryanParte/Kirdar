...
import JoinTrainingSection from './JoinTrainingSection';
...
const Dashboard = () => {
  ...
  const StatCard = ({ icon: Icon, label, value, change }) => (
    <div className="bg-gray-900/50 rounded-xl p-6 border border-gray-800 hover:border-sky-900/50 transition-all duration-300">
